package com.lx.sparkproject.spark.product;
...
import com.lx.sparkproject.util.ParamUtils;
import com.lx.sparkproject.util.SparkUtils;
...
//            @Override
//            public void call(Tuple2<Long, Row> t2) throws Exception {
//
//                System.out.println(" 城市ID："+t2._1+" row: "+t2._2);
//
//            }
//        });
        ...
        cityid2cityInfoRDD.foreach(new VoidFunction<Tuple2<Long, Row>>() {
            @Override
            public void call(Tuple2<Long, Row> t2) throws Exception {

                System.out.println("城市ID： "+t2._1+"  城市信息："+t2._2);
        ...
        DataFrame df = sqlContext.sql("select * from tmp_area_product_click_count");
        ...
        df.javaRDD().foreach(new VoidFunction<Row>() {
            ...
            public void call(Row row) throws Exception {
                ...
                System.out.println("tmp_area_product_click_count: "+row);
            }
        });
        ...
        DataFrame df1 = sqlContext.sql("select * from tmp_area_fullprod_click_count");

        df1.javaRDD().foreach(new VoidFunction<Row>() {
            @Override
            public void call(Row row) throws Exception {


                System.out.println("tmp_area_fullprod_click_count: "+row);
            }
        });
        ...
        System.out.println("areaTop3ProductRDD: ");

        areaTop3ProductRDD.foreach(new VoidFunction<Row>() {
            @Override
            public void call(Row row) throws Exception {
    ...
    private static void generateTempAreaFullProductClickCountTable(SQLContext sqlContext) {
        ...
        String sql =
                "SELECT "
                        + "tapcc.area area,"
                        + "tapcc.product_id product_id,"
                        + "tapcc.click_count click_count,"
                        + "tapcc.city_infos city_infos,"
    ...
    private static JavaRDD<Row> getAreaTop3ProductRDD(SQLContext sqlContext) {
        ...
        String sql = "SELECT "
                        ...
                        +" ORDER BY area ASC, click_count DESC";
