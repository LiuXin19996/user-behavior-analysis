 ...
 *
 */
public class OpUserVisitSessionAnalyzeSpark {
    ...
    public static void main(String[] args) {
        ...
        /**
         * actionRDD就是一个公共RDD
         * 第一：要用actionRDD,获取到一个以sessionid为key的pairRDD
         * 第二：actionRDD用在了session聚合环节里面
         *
         * 对actionRDD进行重构的原因：
         *   以sessionid为key的pairRDD,在以后要多次使用
         *   1.与通过筛选的sessionid进行jion,获得session明细数据
...
//        });
    ...
    private static void randomExtractSession(
        ...
        final Broadcast<Map<String, Map<String, IntList>>> fastutilDateHourExtractMapBroadcast =
