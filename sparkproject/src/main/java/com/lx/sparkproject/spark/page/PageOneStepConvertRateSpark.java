package com.lx.sparkproject.spark.page;
...
import com.lx.sparkproject.util.DateUtils;
import com.lx.sparkproject.util.NumberUtils;
...
public class PageOneStepConvertRateSpark {
    public static  void main(String[] args) {
        ...
        sessionid2actionsRDD.foreach(new VoidFunction<Tuple2<String, Iterable<Row>>>() {
            @Override
            public void call(Tuple2<String, Iterable<Row>> t2) throws Exception {
                System.out.println("\nsessionid: " + t2._1);
        ...
        pageSplitRDD.foreach(new VoidFunction<Tuple2<String, Integer>>() {
            @Override
            public void call(Tuple2<String, Integer> t2) throws Exception {

                System.out.println("t2._1: "+t2._1+" t2._2: "+t2._2);
        ...
        Set<Map.Entry<String, Object>> entries = pageSplitPvMap.entrySet();
